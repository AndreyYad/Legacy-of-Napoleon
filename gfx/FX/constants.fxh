...
static const float COLORMAP_OVERLAY_STRENGTH 	= 1.30f; //0.6f;
...
static const float  WATER_HEIGHT = 9.0f;
...
static const float GB_CAM_MIN = 5.0f;
...
static const float GB_THRESHOLD = 0.5f; // interpolation time
...
static const float GB_OPACITY_NEAR = 1.1f; // Transparency when camera is near
...
static const float GB_STRENGTH_CH1 = 0.6; // Opacity of bottom layer
...
// -------------    RIM LIGHT (PDXMESH)   -----------------------
// --------------------------------------------------------------
static const float 	RIM_START 		= 0.0f;
static const float 	RIM_END 		= 0.0f;
...
// -------------    MAP BORDER (PDXMESH)   ----------------------
// --------------------------------------------------------------
static const float3 BORDER_SUN_INTENSITY = float3(0.0, 0.0, 0.0);
